...
md"""
## Plano Unidade 02 - PROCESSO DE PROJETO 
...
- 🥇 Conhecer os fundamentos para PROJETO CAD.
...
🕐 1. Indicação do tema da atividade a ser executada por cada grupo *(até 05/0ut/2021)*,
 
- _Processo de projeto utilizando CAD._;
...
🕑 5. Avaliações ($(html"<a href='' target='_blank'>Formulário Eletrônico no Google Forms (Acesse aqui)</a>")) *(até 20/out/2021)* e

🕒 6. Feedback (sala) *(até 20/out/2021)*.
"""
